            ...
            <div className="w-full flex flex-col items-center sm:items-start text-center sm:text-left">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 w-full">
                    <div className="space-y-1.5 flex flex-col text-left">
                        <label htmlFor="name" className="block text-[13px] font-medium text-[#A1A1AA]">
                            Name
                        </label>
                        <input
                            id="name"
                        ...
                        />
                        {errors.name && (
                            <p className="text-[#F87171] text-[11px] mt-1">{errors.name.message}</p>
                        )}
                    </div>
                ...
                <p className="text-[13px] text-[#71717A] mt-8 w-full text-center sm:text-left">
                    ...
                    <Link href="/auth/login" className="text-[#FAFAFA] hover:text-[#F49ACB] transition-colors duration-150">
                        Sign in
                    </Link>
                </p>
            </div>
