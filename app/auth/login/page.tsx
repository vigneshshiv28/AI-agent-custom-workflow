            ...
            >
                <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-3xl p-8 shadow-[0_0_50px_-12px_rgba(0,0,0,0.5)] relative overflow-hidden">
                    ...
                    <div className="text-center mb-8 relative z-10">
                        ...
                        <p className="text-neutral-400 text-sm">Sign in to access your workspace</p>
                    </div>
                    ...
                    <form
                        ...
                        <motion.button
                            ...
                            className={`w-full flex items-center justify-center gap-2 bg-gradient-to-r from-primary to-primary/80 text-black font-bold py-3.5 px-4 rounded-xl transition-all hover:shadow-[0_0_20px_-5px_rgba(var(--primary-rgb),0.4)] shadow-lg mt-2 ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''}`}
                        >
                            Login
                            {isSubmitting && (
                    ...
                    <p className="text-center text-neutral-400 text-sm mt-8 relative z-10">
                        ...
                        <Link href="/auth/signup" className="text-primary hover:text-primary/80 font-medium transition-colors hover:underline decoration-primary/30 underline-offset-4">
                            Sign up
                        </Link>
                    </p>
                </div>
