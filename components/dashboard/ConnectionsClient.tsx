    ...
    <div className="h-screen bg-[#09090B] text-[#FAFAFA] font-sans antialiased flex flex-col selection:bg-[#F49ACB]/30 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto relative flex">
          <div className="flex-1 max-w-[1440px] w-full mx-auto px-[32px] py-[32px] flex flex-col gap-[28px]">
            ...
            <div className="relative w-full max-w-[280px]">
              ...
              <input
                type="text"
                className="w-full bg-[#161618] border border-[#26262B] text-[13px] text-[#FAFAFA] placeholder:text-[#71717A] pl-9 pr-4 py-[7px] rounded-[4px] focus:outline-none focus:border-[#404046] transition-colors"
                placeholder="Search"
                value={searchQuery}
            ...
            {isLoading ? (
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3">
                {[1, 2, 3].map(i => (
                  <div key={i} className="bg-[#161618] border border-[#26262B] rounded-[4px] p-4 h-[140px] animate-pulse" />
                ))}
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3">
                {filteredIntegrations.map((integration, idx) => (
                  <div
                    ...
                    className="bg-[#161618] border border-[#26262B] rounded-[4px] p-4 hover:border-[#404046] transition-colors flex flex-col gap-3 group"
                    style={{
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-center gap-3">
                        <div className="w-9 h-9 rounded-[4px] bg-[#111113] border border-[#26262B] flex items-center justify-center shrink-0">
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-[11px] font-mono text-[#F49ACB]/80 bg-[#F49ACB]/10 px-1.5 py-0.5 rounded-sm w-fit mt-0.5">
                    ...
                    <div className="mt-auto pt-1">
                      {integration.status === 'CONNECTED' ? (
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#111113] border border-[#26262B] rounded-[4px] text-[12px] font-mono text-[#F87171] hover:border-[#F87171]/30 hover:bg-[#1C1C1F] active:scale-[0.97] disabled:opacity-50 transition-all duration-150"
                        >
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#F49ACB] rounded-[4px] text-[12px] font-mono font-semibold text-[#09090B] hover:bg-[#e879b0] active:scale-[0.97] disabled:opacity-50 transition-all duration-150"
                        >
      ...
      {integrationToDisconnect && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
          <div
            className="w-full max-w-[400px] bg-[#111113] border border-[#26262B] rounded-[6px] shadow-2xl flex flex-col overflow-hidden animate-in zoom-in-95 duration-200"
            onClick={e => e.stopPropagation()}
          >
            <div className="p-5 flex flex-col gap-3">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-[4px] bg-[#161618] border border-[#26262B] flex items-center justify-center text-[#F87171]">
            ...
            <div className="px-5 py-4 border-t border-[#26262B] bg-[#161618] flex items-center justify-end gap-3">
              <button
                ...
                className="px-4 py-2 text-[13px] font-mono text-[#FAFAFA] bg-transparent hover:bg-[#26262B] border border-[#26262B] rounded-[4px] transition-all duration-150 disabled:opacity-50"
              >
                Cancel
              </button>
              <button
                ...
                disabled={!!disconnecting}
                className="inline-flex items-center gap-2 px-4 py-2 text-[13px] font-mono font-medium text-[#09090B] bg-[#F87171] hover:bg-[#fca5a5] border border-transparent rounded-[4px] transition-all duration-150 active:scale-[0.97] disabled:opacity-50"
              >
