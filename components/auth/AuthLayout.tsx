...
export const AuthLayout: React.FC<AuthLayoutProps> = ({ children }) => {
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#0a0a0c] text-[#FAFAFA] font-sans antialiased selection:bg-[#F49ACB]/30 overflow-hidden relative">
      ...
      {/* Form Container Card */}
      <div className="w-full max-w-[400px] p-8 sm:p-10 flex flex-col bg-gradient-to-b from-[#111113] to-[#0d0d0f] border border-white/[0.08] shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_8px_32px_rgba(0,0,0,0.4)] relative z-10">
